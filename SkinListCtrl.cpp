...
CSkinListCtrl::CSkinListCtrl()
{
	...
	//g_MyClrBgHi = RGB(106,15,0);
	g_MyClrBgHi = RGB(255,255,255);
	
	//g_MyClrFgHi = RGB(229,229,229);

	//g_MyClrFgHi = RGB(255,234,2);
	g_MyClrFgHi = RGB(29,65,81);
}
...
void CSkinListCtrl::OnPaint() 
{
	...
	//memDC.FillSolidRect(clip, RGB(134,30,0));
	memDC.FillSolidRect(clip,RGB(29,65,81));
	   
	//SetTextBkColor(RGB(76,85,118));
	//SetTextBkColor(RGB(134,30,0));
	SetTextBkColor(RGB(29,65,81));
...
//	CRect vBar(windowRect.right-nDialogFrameWidth,windowRect.top-nTitleBarHeight-nDialogFrameHeight,windowRect.right+12-nDialogFrameWidth,windowRect.bottom+12-nTitleBarHeight-nDialogFrameHeight);
	CRect vBar(windowRect.right-nDialogFrameWidth,windowRect.top-nTitleBarHeight-nDialogFrameHeight,windowRect.right+8-nDialogFrameWidth,windowRect.bottom+12-nTitleBarHeight-nDialogFrameHeight);
//	CRect hBar(windowRect.left-nDialogFrameWidth,windowRect.bottom-nTitleBarHeight-nDialogFrameHeight,windowRect.right+1-nDialogFrameWidth,windowRect.bottom+12-nTitleBarHeight-nDialogFrameHeight);
	...
	m_SkinVerticleScrollbar.SetWindowPos(NULL,vBar.left,vBar.top,vBar.Width(),vBar.Height()-12,SWP_NOZORDER);
...
void CSkinListCtrl::ForceVThumbPaint()
{
//	m_SkinVerticleScrollbar.Invalidate();
	m_SkinVerticleScrollbar.UpdateThumbPosition();
}
